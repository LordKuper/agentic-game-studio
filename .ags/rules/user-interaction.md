...
1. If `.ags/project/user-interaction.md` exists — follow it.
2. Else bootstrap:
   - Read `.ags/templates/t_user-interaction.md`.
   - Ask user one question per template field.
   - After all answers collected, create `.ags/project/user-interaction.md` from template, filled.
...
1. **Draft + discuss in user's chosen language.** Present proposed content, ask questions, collect feedback, iterate — all in the chat language from `user-interaction.md`. Section drafts shown for approval are in user's language.
