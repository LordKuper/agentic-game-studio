...
### Session State File
Maintain `.ags/project/session-state.md` as a living checkpoint. Update it
...
- Reference to `.ags/project/session-state.md` (read it to recover state)
...
**After compaction:** Read `.ags/project/session-state.md` and any files being
...
1. The `session-start.sh` hook will detect and preview `session-state.md` automatically
