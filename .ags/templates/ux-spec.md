...
> **Author**: [Name or agent вЂ” e.g., ui-designer]
> **Last Updated**: [Date]
> **Screen / Flow Name**: [Short identifier used in code and tickets вЂ” e.g., `InventoryScreen`, `NewGameFlow`]
> **Platform Target**: [PC | Console | Mobile | All вЂ” list all that this spec covers]
> **Related GDDs**: [Links to the GDD sections that generated this UI requirement вЂ” e.g., `design/gdd/inventory.md В§ UI Requirements`]
> **Related ADRs**: [Any architectural decisions that constrain this screen вЂ” e.g., `ADR-0012: UI Framework Selection`]
> **Related UX Specs**: [Sibling and parent screens вЂ” e.g., `ux-spec-pause-menu.md`, `ux-spec-settings.md`]
> **Accessibility Tier**: Basic | Standard | Comprehensive | Exemplary

> **Note вЂ” Scope boundary**: This template covers discrete screens and flows (menus,
...
> touching any layout decisions вЂ” it is the filter through which every subsequent choice
> is evaluated.
...
Example вЂ” bad: "Displays the player's current items and equipment."
Example вЂ” good: "Lets the player understand what they're carrying and quickly decide what
...
> context so that design decisions вЂ” what to show first, what to hide, what to animate,
> what to simplify вЂ” are calibrated to the actual player arriving at this screen, not
> an abstract user.

| Question | Answer |
|----------|--------|
| What was the player just doing? | [e.g., Completed a combat encounter / Pressed Esc from exploration / Triggered a story cutscene] |
| What is their emotional state? | [e.g., High tension вЂ” just narrowly survived / Calm вЂ” exploring between objectives] |
| What cognitive load are they carrying? | [e.g., High вЂ” actively tracking enemy positions / Low вЂ” no active threats] |
| What information do they already have? | [e.g., They know they just picked up an item but haven't seen its stats yet] |
| What are they most likely trying to do? | [e.g., Check if the new item is better than their current weapon вЂ” primary use case] |
...
Example: "Confident and in control вЂ” the player should feel like they have complete
...
> reveals architectural problems early вЂ” if this screen is reachable from eight
...
```
[Root вЂ” e.g., Main Menu]
  в””в”Ђв”Ђ [Parent Screen вЂ” e.g., Settings]
        в””в”Ђв”Ђ [This Screen вЂ” e.g., Audio Settings]
              в”њв”Ђв”Ђ [Child Screen вЂ” e.g., Advanced Audio Options]
              в””в”Ђв”Ђ [Child Screen вЂ” e.g., Speaker Test Dialog]
```
...
> must the player complete it? Undismissable modals are high-friction вЂ” justify them.

**Reachability вЂ” all entry points**:

| Entry Point | Triggered By | Notes |
|-------------|-------------|-------|
| [e.g., Main Menu в†’ Play] | [Player selects "New Game"] | [Primary entry point] |
| [e.g., Pause Menu в†’ Resume] | [Player presses Start from any gameplay state] | [Secondary entry] |
| [e.g., Game event] | [Tutorial system forces open first time only] | [Systemic entry вЂ” must not break if player dismisses] |
...
> Transitions that are undefined become bugs вЂ” the player finds themselves stuck, or the
...
|---------|----------------------|-----------------|----------------|-------|
| [e.g., Player presses Inventory button] | [Gameplay / Exploration state] | [Overlay push вЂ” game pauses] | [Current player loadout, inventory contents] | [Works from any non-combat state] |
...
|-------------|------------|-----------------|----------------------|-------|
| [e.g., Player closes inventory (Back/B/Esc)] | [Previous state вЂ” Exploration] | [Overlay pop вЂ” game resumes] | [Updated equipment loadout committed] | [Changes must be committed before transition begins] |
...
> UX design and UI programming. It does not need to be pixel-perfect вЂ” it needs to
...
[Draw the screen layout using ASCII art. Suggested characters:
 в”Њ в”ђ в”” в” в”‚ в”Ђ    for borders
 в•” в•— в•љ в•ќ в•‘ в•ђ    for emphasized/modal borders
 [ ]              for interactive elements (buttons, inputs)
 { }              for content areas (lists, grids, images)
 ...              for scrollable content
 в—Џ                for the focused element on open
...
в”‚  [в†ђ Back]        INVENTORY         [Options] в”‚  в†ђ HEADER ZONE
в”њв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”¤
в”‚ в”Њв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”ђ  в”Њв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”ђв”‚
в”‚ в”‚ CATEGORY NAV в”‚  в”‚  ITEM DETAIL PANEL      в”‚в”‚  в†ђ CONTENT ZONE
в”‚ в”‚  в—Џ Weapons   в”‚  в”‚  Item Name              в”‚в”‚
в”‚ в”‚    Armor     в”‚  в”‚  {item icon}            в”‚в”‚
в”‚ в”‚    Consumableв”‚  в”‚  Stats comparison       в”‚в”‚
в”‚ в”‚    Key Items в”‚  в”‚  Description text...    в”‚в”‚
в”‚ в”њв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”¤  в””в”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”в”‚
в”‚ в”‚ ITEM GRID    в”‚                             в”‚
...
в”њв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”Ђв”¤
в”‚   [Equip]     [Drop]     [Compare]  [Close]  в”‚  в†ђ ACTION BAR
...
| [e.g., Category Nav] | [Left panel: item category tabs] | [~25% width, ~75% height] | [Yes вЂ” vertical if categories exceed panel] | [Scroll indicator appears at bottom of list] |
| [e.g., Item Grid] | [Center: grid of item icons for selected category] | [~45% width, ~75% height] | [Yes вЂ” vertical] | [Page-based: 4x4 grid, next page on overflow] |
| [e.g., Detail Panel] | [Right: stats and description for selected item] | [~30% width, ~75% height] | [Yes вЂ” vertical for long descriptions] | [Fade at bottom, scroll to reveal] |
...
> task list вЂ” each row becomes a component to build or reuse.

| Component Name | Type | Zone | Purpose | Required? | Reuses Existing Component? |
|----------------|------|------|---------|-----------|---------------------------|
| [e.g., Back Button] | [Button] | [Header] | [Returns to previous screen] | [Yes] | [Yes вЂ” standard NavButton component] |
| [e.g., Screen Title Label] | [Text] | [Header] | [Displays "INVENTORY" or context name] | [Yes] | [Yes вЂ” ScreenTitle component] |
| [e.g., Category Tab] | [Toggle Button] | [Category Nav] | [Filters item grid by category] | [Yes] | [No вЂ” new component needed] |
| [e.g., Item Slot] | [Icon + Frame] | [Item Grid] | [Represents one inventory slot, empty or filled] | [Yes] | [No вЂ” new component] |
| [e.g., Item Name Label] | [Text] | [Detail Panel] | [Shows selected item's name] | [Yes] | [Yes вЂ” BodyText component] |
| [e.g., Stat Comparison Row] | [Compound вЂ” label + value + delta] | [Detail Panel] | [Shows stat value vs. currently equipped] | [Yes] | [No вЂ” new component] |
| [e.g., Equip Button] | [Primary Button] | [Action Bar] | [Equips selected item in appropriate slot] | [Yes] | [Yes вЂ” PrimaryAction component] |
| [e.g., Empty State Message] | [Text + Icon] | [Item Grid] | [Shown when category has no items] | [Yes] | [Yes вЂ” EmptyState component] |

**Primary focus element on open**: [e.g., The first item in the Item Grid вЂ” or, if deep-linked, the highlighted item. If the grid is empty, focus lands on the first Category Tab.]

---

## 6. States & Variants

> **Why this section exists**: A screen is not a single picture вЂ” it is a set of
...
| [Empty вЂ” no items in category] | [Player switches to a category with zero items] | [Item Grid replaced by EmptyState component: icon + "Nothing here yet."] | [Action Bar shows no item actions; Drop/Equip/Compare all hidden] | [Do not show disabled buttons вЂ” remove them. Disabled buttons with no tooltip are confusing.] |
| [Populated вЂ” items present] | [Category has at least one item] | [Item Grid fills with item slots; first slot is auto-focused] | [All item actions available for selected item] | [Default and most common state] |
| [Item Selected] | [Player navigates to an item slot] | [Detail Panel populates; selected slot has focus ring; Action Bar updates to item's valid actions] | [Equip/Drop/Compare enabled based on item type] | [Equip is disabled if item is already equipped вЂ” show a "Equipped" badge instead] |
| [Confirmation Pending вЂ” Drop] | [Player selects Drop action] | [Confirmation dialog overlays the screen] | [All background interactions suspended until dialog resolves] | [Use a modal confirmation, not an inline toggle. Items cannot be recovered after dropping.] |
| [Error вЂ” data load failed] | [Inventory data could not be retrieved] | [Item Grid shows error state: icon + "Couldn't load items." + Retry button] | [Only Retry and Close are available] | [Log the error; do not expose technical details to player] |
...
> interaction map is also the input for the accessibility audit вЂ” if an action is
...
| [Tab / R1] | [KB / Gamepad] | [Move focus to next zone (Category в†’ Grid в†’ Detail в†’ Action Bar)] | [Focus ring jumps to first element in next zone] | [Distinct zone-change tone] | [Shift+Tab / L1 goes backward] |
| [Mouse hover] | [PC] | [Show hover state on interactive elements] | [Highlight / underline / color shift] | [None] | [Hover does NOT move focus вЂ” only click does] |
...
|-------|----------|-------------------------------|--------|----------|-----------|-----------|-------|
| [Enter / A button / Left click] | [All] | [Item slot focused] | [Select item в†’ populate Detail Panel] | [Detail panel slides in or updates in place] | [Panel fade/slide in, 120ms] | [Soft select tone] | [If item already selected: no-op] |
...
| [Esc / B button / Back] | [All] | [Any, screen level] | [Close screen and return to previous state] | [Screen exit transition plays] | [Slide out, 200ms] | [Back/close tone] | [Commits all changes before closing. No discard вЂ” inventory is not a draft.] |
...
| [Confirmation dialog open] | [Only Confirm and Cancel inputs active] | [Modal вЂ” background is locked] |
...
|--------------|--------------|-----------------|-------------|--------|------------------------|
| [e.g., Item list] | [Inventory System] | [On screen open; on InventoryChanged event] | [InventorySystem] | [Array of ItemData structs: id, name, icon_path, category, stats, is_equipped] | [Empty array в†’ show Empty State. Never null вЂ” system must return array.] |
| [e.g., Equipped loadout] | [Equipment System] | [On screen open; on EquipmentChanged event] | [EquipmentSystem] | [Dict mapping slot_id в†’ item_id] | [Unequipped slot has null value вЂ” UI shows empty slot icon] |
| [e.g., Item stat comparisons] | [Stats System] | [On item selection change] | [StatsSystem] | [Dict mapping stat_name в†’ {current, new, delta}] | [If no item selected, detail panel shows placeholder. Stats system must handle this gracefully.] |
| [e.g., Player currency] | [Economy System] | [On screen open only вЂ” inventory does not show live currency] | [EconomySystem] | [Int вЂ” gold pieces] | [If currency system not active for this game mode, hide the currency row entirely] |
...
| [Player opens item compare] | [ItemCompareOpened] | [{item_a_id: string, item_b_id: string}] | [Analytics System] | [No game-state change вЂ” analytics event only. Compare view is purely local UI state.] |
...
> **Why this section exists**: Transitions are not decoration вЂ” they communicate
...
|------------|---------|-----------------|--------------|--------|----------------|---------------------------|
| [Screen enter] | [Screen pushed onto stack] | [Slide in from right] | [250] | [Ease out cubic] | [No вЂ” must complete before interaction is enabled] | [Yes вЂ” instant appear at 0ms] |
| [Screen exit вЂ” Back] | [Player presses Back] | [Slide out to right] | [200] | [Ease in cubic] | [No] | [Yes вЂ” instant disappear] |
| [Screen exit вЂ” Forward] | [Player navigates to child screen] | [Slide out to left] | [200] | [Ease in cubic] | [No] | [Yes вЂ” instant] |
| [Detail panel update] | [Player selects a new item] | [Cross-fade content] | [120] | [Linear] | [Yes вЂ” if player navigates quickly, previous animation cancels] | [Yes вЂ” instant swap] |
| [Loading в†’ Populated] | [Data arrives after load] | [Skeleton shimmer fades out, content fades in] | [180] | [Ease out] | [No] | [Yes вЂ” instant reveal] |
| [Action Bar button press] | [Player activates a button] | [Scale down 95% on press, return on release] | [60 down / 60 up] | [Ease out / ease in] | [Yes вЂ” if released early, returns to normal] | [No вЂ” this is tactile feedback, not decorative motion] |
| [Confirmation dialog open] | [Player initiates destructive action] | [Background dims 60% opacity; dialog scales up from 95%] | [150] | [Ease out] | [No] | [Yes вЂ” instant appear, no scale] |
| [New item badge appear] | [Screen opens with newly acquired item] | [Badge pops from 0% to 110% to 100% scale] | [200 total] | [Ease out back] | [No] | [Yes вЂ” instant appear at 100% scale] |

---

## 11. Input Method Completeness Checklist

> **Why this section exists**: Input completeness is not optional вЂ” it is a
...
- [ ] Right-click behavior defined (context menu or no-op вЂ” not undefined)
...
> live in `docs/accessibility-requirements.md` вЂ” consult it before filling this
...
|--------------|-------------------|---------------|---------------|-------|
| [e.g., Item name in Detail Panel] | [Dark panel background ~#1a1a1a] | [4.5:1 (WCAG AA normal text)] | [TBD вЂ” verify in implementation] | [ ] |
| [e.g., Category tab label вЂ” inactive] | [Mid-grey tab background] | [4.5:1] | [TBD] | [ ] |
| [e.g., Category tab label вЂ” active] | [Accent color background] | [4.5:1] | [TBD] | [ ] |
| [e.g., Action button label] | [Button color (varies by state)] | [4.5:1] | [TBD] | [ ] |
| [e.g., Stat comparison delta (positive)] | [Detail panel] | [4.5:1 вЂ” do NOT rely on green color alone] | [TBD] | [ ] |

**Colorblind-unsafe elements and mitigations**:

| Element | Colorblind Risk | Mitigation |
|---------|----------------|------------|
| [e.g., Stat delta indicators (red/green for worse/better)] | [Red-green colorblindness (Deuteranopia) вЂ” most common form] | [Add arrow icons (в†‘ / в†“) and +/- prefix in addition to color. Color is a redundant, not sole, indicator.] |
| [e.g., Item rarity color coding (grey/green/blue/purple/orange)] | [Multiple types вЂ” rarity color is a common industry failure] | [Add rarity name text label below icon. Color is supplemental only.] |
...
3. Category Tab 1 вЂ” Weapons
4. Category Tab 2 вЂ” Armor
5. Category Tab 3 вЂ” Consumables
6. Category Tab 4 вЂ” Key Items
7. Item Slot [0,0]
...
в†’ Cycles back to Back button

Focus does not enter the Detail Panel вЂ” it is a display panel driven by item focus, not independently navigable.]
...
That is 5 concurrent streams вЂ” within the standard 7В±2 limit, but at the higher end.
...
> translation. German text is typically 30вЂ“40% longer than English. Arabic and Hebrew
...
- RTL layout (Arabic, Hebrew): mirrored layout required вЂ” document which elements mirror and which do not
- CJK languages (Japanese, Korean, Chinese): text may be 20-30% shorter вЂ” verify layouts do not look broken with less text
- Do not use text in images вЂ” all text must be from localization strings

| Text Element | English Baseline Length | Max Characters | Expansion Budget | RTL Behavior | Overflow Behavior | Risk |
|--------------|------------------------|----------------|-----------------|--------------|-------------------|------|
| [e.g., Screen title "INVENTORY"] | [9 chars] | [16 chars] | [78%] | [Mirror to right, or center вЂ” acceptable] | [Truncate with ellipsis вЂ” title is not critical content] | [Low] |
| [e.g., Item name] | [~15 chars avg, max ~35 "Enchanted Dragon Scale Gauntlets"] | [50 chars] | [43%] | [Right-align in RTL layouts] | [Truncate with tooltip showing full name on hover/focus] | [Medium вЂ” long fantasy item names are common] |
| [e.g., Item description] | [~80вЂ“120 chars] | [200 chars] | [67%] | [Right-align, wrap normally] | [Scroll within Detail Panel вЂ” no truncation] | [Low вЂ” panel is scrollable] |
| [e.g., Action button "Equip"] | [5 chars] | [14 chars] | [180%] | [Button layout mirrors; text right-aligns] | [Shrink font to 90% minimum, then truncate] | [Medium вЂ” "AusrГјsten" in German is 9 chars] |
| [e.g., Category tab "Consumables"] | [11 chars] | [18 chars] | [64%] | [Mirror tab position] | [Abbreviate: "Consum." вЂ” define abbreviations per language in loc file] | [High вЂ” long localized tab labels are a known problem] |
...
> designer what they meant. Every criterion should be binary вЂ” pass or fail, not
> subjective.
...
- [ ] Navigation between items produces no perceptible frame drop (maintain target framerate В±5fps)
...
- [ ] No text overflow or truncation in the longest-translation language [specify вЂ” typically German]
...
- [ ] All text elements are driven by localization strings вЂ” no hardcoded display text
...
> and a deadline. An Approved spec must have zero open questions вЂ” move to a decision
...
| [e.g., Do we support controller cursor (free aim) in the item grid, or d-pad-only grid navigation?] | [lead-programmer + ui-designer] | [Sprint 4, Day 3] | [Pending вЂ” depends on ADR-0015 input model decision] |
| [e.g., What is the game's item drop policy вЂ” permanent loss or drop-to-world?] | [systems-designer] | [Requires GDD update] | [Blocked on inventory GDD Edge Cases section] |
| [e.g., Maximum inventory size вЂ” does the grid have a hard cap or is it infinite-scroll?] | [systems-designer] | [Sprint 3, Day 5] | [Pending] |
