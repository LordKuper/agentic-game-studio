...
### [Story Title] вЂ” Logic

**Test file path**: `tests/unit/[system]/[story-slug]_test.[ext]`

**What to test**:
- [Formula or rule from GDD Formulas section вЂ” e.g., "damage = base * multiplier where multiplier в€€ [0.5, 3.0]"]
...
### [Story Title] вЂ” Integration

**Test file path**: `tests/integration/[system]/[story-slug]_test.[ext]`

**What to test**:
- [Cross-system interaction вЂ” e.g., "applying buff updates CharacterStats and triggers UI refresh"]
- [Round-trip вЂ” e.g., "save в†’ load restores all fields"]

---

## Manual QA Checklist

### [Story Title] вЂ” Visual/Feel
...
- [ ] [Specific observable condition вЂ” e.g., "hit flash appears on frame of impact, not the frame after"]
...
Sign-off requirement: Playtest notes в†’ `.ags/project/session-logs/playtest-[sprint]-[story-slug].md`
...
- [ ] All acceptance criteria verified вЂ” automated test result OR documented manual evidence
...
- [ ] No regressions introduced вЂ” previous sprint's features still pass
...
| [title] | PASS | вЂ” | PASS | |
| [title] | вЂ” | PASS | PASS | |
| [title] | FAIL | вЂ” | BLOCKED | [describe failure] |
...
- **QA Tester**: [name] вЂ” [date]
- **QA Lead**: [name] вЂ” [date]
- **Sprint Owner**: [name] вЂ” [date]

*Template: `.ags/templates/test-plan.md`*
*Generated by: `/qa-plan` вЂ” do not edit this line*
