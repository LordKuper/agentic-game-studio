...
- `/ags-reverse-document [type] [path]` — [For which gap]
- `/ags-architecture-decision` — [For which gap]
- `/ags-sprint-plan` — [If production planning missing]
- `/ags-milestone-review` — [If approaching deadline]
- `/ags-onboard [role]` — [If new contributor]
...
*Generated by `/ags-project-stage-detect` skill*
