...
|------|------|------------|
| TR registry | `design/architecture/tr-registry.yaml` | **STOP** — "TR registry not found. Run `/create-epics` to generate it." |
...
| Control manifest | `design/architecture/control-manifest.md` | **WARN and continue** — "Control manifest not found — layer rules cannot be checked. Run `/create-control-manifest`." |
...
- **Visual/Feel criteria deferred, not skipped** — mark DEFERRED; manually verified in `/story-done`
