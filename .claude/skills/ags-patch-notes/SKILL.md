...
- Read the internal changelog at `.ags/project/releases/[version]/ags-changelog.md` if it exists
...
- Read sprint retrospectives in `.ags/project/epics/` for context
...
- Run `/ags-release-checklist` to verify all other release gates are met before publishing.
...
2. Persist current draft to `.ags/project/reviews/.tmp/patch-notes-[version]-iter[N]-draft.md`.
