...
- `/create-stories .ags/project/epics/combat/EPIC.md` — full path also accepted
...
- **Verdict: COMPLETE** — [N] stories written to `.ags/project/epics/[epic-slug]/`. Run `/story-readiness` → `/dev-story` to begin implementation.
