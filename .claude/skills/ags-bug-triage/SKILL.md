...
**Modes:**
- `/ags-bug-triage sprint` — triage against the current sprint; assign fixable bugs
  to the sprint backlog; defer the rest
- `/ags-bug-triage full` — full triage of all bugs regardless of sprint scope
- `/ags-bug-triage trend` — trend analysis only (no assignment); read-only report
