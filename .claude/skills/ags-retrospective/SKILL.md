...
- For sprint retrospectives: `.ags/project/retrospectives/retro-[sprint-slug]-*.md`
  (also check `.ags/project/sprints/sprint-[N]-retrospective.md` as an alternate location)
- For milestone retrospectives: `.ags/project/retrospectives/retro-[milestone-name]-*.md`
...
- Sprint plans: `.ags/project/sprints/`
- Milestone definitions: `.ags/project/milestones/`

**If the file does not exist or is empty**, output:

> "No sprint data found for [sprint/milestone]. Run `/ags-sprint-status` to generate
...
Read previous retrospectives (if any) from `.ags/project/sprints/` or `.ags/project/milestones/` to check:
...
- Run `/ags-sprint-plan` to incorporate the action items and velocity data into the next sprint.
- If this was a milestone retrospective, run `/ags-gate-check` to formally assess readiness for the next phase.
