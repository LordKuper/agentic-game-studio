...
```
Usage: /ags-skill-improve [skill-name]
Example: /ags-skill-improve tech-debt
```
...
Run `/ags-skill-test static [name]` and record the baseline score:
- Count of FAILs
- Count of WARNs
...
If category is found, run `/ags-skill-test category [name]` and record the category baseline:
- Count of FAILs
- Count of WARNs
...
Re-run `/ags-skill-test static [name]` and record the new static score.
If a category was assigned, also re-run `/ags-skill-test category [name]` and record the new category score.
...
- Run `/ags-skill-test static all` to find the next skill with failures.
- Run `/ags-skill-improve [next-name]` to continue the loop on another skill.
- Run `/ags-skill-test audit` to see overall coverage progress.
