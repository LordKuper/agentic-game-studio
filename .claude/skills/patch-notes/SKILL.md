...
- Read the internal changelog at `.ags/project/releases/[version]/changelog.md` if it exists
...
- Read sprint retrospectives in `.ags/project/sprints/` for context
- Read any balance change documents in `design/balance/`
- Read bug fix records from QA if available

**If no changelog data is available** (neither `.ags/project/releases/[version]/changelog.md`
...
if needed. Also write to `.ags/project/releases/[version]/patch-notes.md` as the
