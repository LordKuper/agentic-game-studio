...
Coordinates with:
- `tools-programmer` for build pipelines, CI/CD, and deployment automation
- `qa-lead` for quality gates, test results, and release readiness sign-off
- `producer` for launch communications and player-facing messaging (producer absorbs community-manager scope)
